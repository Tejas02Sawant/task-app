# EasyTask is multi-user task tracker to monitor individual user's task. The app allows you to add new tasks, mark tasks as complete and sort their task list for better management.
